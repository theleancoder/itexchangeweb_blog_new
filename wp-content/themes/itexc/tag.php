    ...
    <div class="container wpsearch-blogbody" id="blogBody">
        ...
        <div class="col-md-12 col-xs-12 wpheading">
            <div class="col-xs-12 wpheading-container">
                ...
                <span><?php _e('Tag', 'itexc') ?>: </span><span class="wp-blue-color"><?php single_tag_title(); ?> </span>
            </div>
        </div>
...
<a href="<?php echo get_permalink(); ?>">
            ...
            <div class="loadmore-container">
                <a style="display:none;" href="javascript:void(0);" date-query="<?php echo $tagslug; ?>" data-perPage="<?php echo $perPage; ?>" data-displayed="<?php echo $perPage; ?>" data-ajaxtype="tag" data-totalposts="<?php echo $totalposts; ?>"  class="loadmore btn btn-md">Load More</a>
            </div>
            <!-- loader ajax start -->
