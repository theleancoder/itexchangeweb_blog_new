    ...
    <div class="container wpsearch-blogbody" id="blogBody">
        ...
        <div class="col-md-12 col-xs-12 wpheading">
            <div class="col-xs-12 wpheading-container">
                ...
                <span><?php _e('Author', 'itexc') ?>: </span><span class="wp-blue-color">
                <?php
                global $wp_query;
...
<a href="<?php echo get_permalink(); ?>">
            ...
            $autherid = get_the_author_meta('ID');

              ?>
              <div class="loadmore-container">
              <a style="display:none;" href="javascript:void(0);" date-query="<?php echo $autherid; ?>" data-perPage="<?php echo $perPage; ?>" data-displayed="<?php echo $perPage; ?>" data-ajaxtype="author" data-totalposts="<?php echo $totalposts; ?>"  class="loadmore btn btn-md">Load More</a>
              </div>
              <!-- loader ajax start -->
